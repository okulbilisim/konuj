...
<title>Kivvii - İletişim</title>
<meta name="description" content="Kivvii ile hiç tanımadığınız biriyle isimsiz sohbet edebilirsiniz. Haydi sen de Kivviile!" />
<meta name="keywords" content="sohbet, chat, kivi, anlık mesajlaşma, anlık, mesaj, ileti, muhabbet, yabancı" />
...
<div id="hd">
	...
	<ul id="nav">
	<li><a href="./" title="Anasayfa" alt="Anasayfa">Anasayfa</a></li>
	...
	<li class="active"><a href="./sss" title="Sıkça Sorulan Sorular" alt="Sıkça Sorulan Sorular">SSS</a></li>
...
<div id="bd">
	...
	<div class="main-col">
		...
		<ul>
			<li>- "Kivvii" Nedir?</li>
			<li>- Kivvii, bir takım genç insanların beyin fırtınası sonucu ortaya çıkardıkları Web 2.0 innovasyon projesidir.</li>
			<br />
		</ul>
	</div>
</div>
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-735148-6");
