...
<div id="hd">
	...
	<li class="active"><a href="./hakkimizda" title="Hakkımızda" alt="Hakkımızda">Hakkımızda</a></li>
...
<div id="bd">
	...
	<div class="main-col">
		<h3>Hakkımızda</h3>
		<span class="hr">&nbsp;</span>
		<p>Kivvii, bir takım genç insanların beyin fırtınası sonucu ortaya çıkardıkları Web 2.0 innovasyon projesidir.</p>
		<p></p>
	</div>
</div>
